...
void display(void){
    ...
    glScalef(0.8, 2.5, 1.5);
    glutSolidSphere(7.0, 50.0, 50.0);
    glPopMatrix();

    /* Janela 1 */

    glTranslatef(6.5, 10.0, 7.0);
    glRotatef(270, 0, 1, 0);
    glPushMatrix();
    glColor3f(0.0, 1.0, 1.0);
    glScalef(1.0, 1.0, 1.0);
    glutSolidCone(3.0, 8.0, 50.0, 50.0);
    glPopMatrix();
    ...
    glTranslatef(7.0, -6.0, 1.0);
    glRotatef(270, 0, 1, 0);
    glPushMatrix();
    glColor3f(0.0, 1.0, 1.0);
    glScalef(0.5, 3.5, 1.8);
    glutSolidSphere(2.0, 50.0, 50.0);
    glPopMatrix();

    /* Coroa */

    glTranslatef(5.0, 23.0, 2.0);
    glRotatef(30, 1, 0, 0);
    glPushMatrix();
    ...
    glTranslatef(-35.0, -26.5, -3.0);
    glPushMatrix();
    glColor3f(0.5, 0.5, 0.5);
    glScalef(30.0, 1.5, 2.6);
    glutSolidCube(2.0);
    glPopMatrix();
    ...
    glTranslatef(38.0, -38.0, -35.0);
    glPushMatrix();
    glColor3f(0.0, 1.0, 0.0);
    glScalef(1.0, 1.0, 1.0);
    glutSolidSphere(6, 50.0, 50.0);
    glPopMatrix();
